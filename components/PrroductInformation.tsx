    ...
    >
      {products === 'fruits' && 'diameter' in props ? (
        <div className="relative z-10 px-8 py-6 text-white">
          ...
          <ul className="ml-4">
            <li>Đường kính: Từ {props.diameter[0]}cm đến {props.diameter[1]}cm</li>
            <li>Trọng lượng: Từ {props.weight[0]}kg đến {props.weight[1]}kg</li>
        ...
        <div className="relative z-10 px-8 py-6 text-white">
          ...
          <ul className="ml-4">
            ...
            <li>Số lượng quả: {props.fruitQuantity[0]} đến {props.fruitQuantity[1]} quả</li>
