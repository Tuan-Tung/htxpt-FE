...
const DetailInfoGarden = ({ name, bonsaiQuantity, fruitQuantity, joinedAt }: IPropInfoGarden) => {
  return (
    <div className=" mt-5 flex min-h-[179px] w-full rounded-xl bg-white p-6 shadow">
      <div
      ...
      <div className='flex px-6 py-4'>
        <div className='item-content flex flex-wrap'>
          <div className="flex">
            ...
            <div className="text-sm font-normal leading-tight text-lime-600">{bonsaiQuantity}</div>
          </div>
          <div className="inline-flex w-full justify-start gap-[5px]">
            ...
            <div className="text-sm font-normal leading-tight text-lime-600">4.5 (59.4k Đánh Giá)</div>
          </div>
          <div className="inline-flex w-full justify-start gap-[5px]">
            <div className="flex justify-start gap-[5px]">
            ...
            <div className="text-sm font-normal leading-tight text-lime-600">{formatDateForm(joinedAt)}</div>
          </div>
        </div>
        <div className='item-content flex flex-wrap'>
          <div className="inline-flex w-full justify-start gap-[5px]">
            <div className="flex justify-start gap-[5px]">
              <Icon color="#699C3A" name="ic_card_category_outline" size={20} aria-label="Location Icon" />
          ...
          <div className="inline-flex w-full justify-start gap-[5px]">
            <div className="flex justify-start gap-[5px]">
              <Icon color="#699C3A" name="ic_message_square_outline" size={20} aria-label="Location Icon" />
              <div className="text-sm font-normal leading-tight text-black">Tỉ Lệ Phản Hồi Chat:</div>
            </div>
