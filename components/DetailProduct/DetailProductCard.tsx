...
const DetailProductCard = (props: PropsDetailProduct) => {
  ...
  const { title, CommonProduct, bonsaiQuantity, fruitQuantity, joinedAt, name, quantity, productImg } = props;
    ...
    <div>
      <div className=' bg-white p-8'>
        <div className="inline-flex w-full items-start justify-start gap-8">
          <div className="max-h-[374px] max-w-[356px]">
            {productImg ? <Image src={productImg[imgIndex]?.url} alt="logo" width={356} height={294} className='mr-3 h-[374px] w-[356px]' /> : null}

          </div>
          <div className="inline-flex w-2/3 flex-col items-start justify-center gap-5">
            ...
            <div className="inline-flex items-center justify-start gap-4">
              <div className="flex items-center justify-center gap-2.5 rounded-lg border-2 border-lime-600 px-6 py-3">
