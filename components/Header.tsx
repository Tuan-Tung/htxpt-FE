...
const Header: React.FC = (): React.ReactElement => {
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50 flex h-[72px] w-auto flex-row items-center justify-between bg-gradient-to-r from-primary to-primary_dark px-4 shadow-[0_2px_16px_rgba(31,41,20,0.15)] md:left-[260px] md:px-[56px]">
