    ...
    <div className="rounded-lg bg-background">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-5">
          ...
          <h1 className="text-2xl font-extrabold text-black md:text-4xl">{dataDetail.tree_name}</h1>

          <div className="flex items-center gap-2 rounded-xl bg-white p-4 shadow-card">
            <span className="text-2xl">🌿</span>
            <span className="text-dark_grey">
              <span className="font-semibold text-black">Số lượng còn:</span> {dataDetail.quantity} cây
            </span>
          </div>
          ...
          {dataDetail.story && (
            <div className="rounded-2xl bg-primary_light/60 p-6">
              <h2 className="mb-3 text-lg font-bold text-black">Câu chuyện - Bài thơ</h2>
              <div
