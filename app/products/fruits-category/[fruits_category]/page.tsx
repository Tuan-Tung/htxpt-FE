    ...
    <div className="rounded-lg bg-background">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-5">
          ...
          <h1 className="text-2xl font-extrabold text-primary_green md:text-4xl">{dataDetail.category_name}</h1>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="rounded-xl bg-white p-4 text-center shadow-card">
              ...
              <div className="mt-1 font-bold text-primary_green">{dataDetail.weight}</div>
            </div>
            <div className="rounded-xl bg-white p-4 text-center shadow-card">
              <div className="text-xs uppercase tracking-wide text-dark_grey/60">Đường kính</div>
              <div className="mt-1 font-bold text-primary_green">{dataDetail.dimeter}</div>
            </div>
            <div className="rounded-xl bg-white p-4 text-center shadow-card">
              <div className="text-xs uppercase tracking-wide text-dark_grey/60">Khoảng giá</div>
              <div className="mt-1 font-bold text-primary_green">{dataDetail.range_price} VNĐ</div>
            </div>
          </div>

          <div>
            <h2 className="mb-2 text-lg font-bold text-primary_green">Kiểu dáng</h2>
